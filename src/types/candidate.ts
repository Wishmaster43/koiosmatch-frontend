...
export interface CandidateStats {
  ...
  attention?: { stale_6m?: number; never_contacted?: number; tasks?: number; no_followup_planned?: number; missing_appointment?: number; intake_planned?: number; active_conversations?: number }
