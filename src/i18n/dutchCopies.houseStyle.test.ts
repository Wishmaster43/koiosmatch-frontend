...
const ALLOWLIST: string[] = [
  ...
  // cognate reasoning as the es/ block above)
  'it/analytics:candidates.axes.phase',
  'it/analytics:applications.axes.stage',
  'it/analytics:customers.axes.phase',
  'it/applications:add.phase',
  'it/applications:cols.phase',
  'it/applications:insights.phase',
  'it/applications:drawer.phase',
  'it/applications:status.phase',
  'it/candidates:columns.phase',
  'it/candidates:filters.phase',
  'it/candidates:drawer.phase',
  'it/candidates:work.phase',
  'it/candidates:changelog.axisPhase',
  'it/candidates:changelog.fields.phase',
  'it/candidates:matchesView.stage',
  'it/customers:cols.phase',
  'it/customers:filters.phase',
  'it/customers:drawer.phase',
  'it/customers:opportunities.col.stage',
  'it/customers:modal.fields.phase',
  'it/dashboard:feed.col.stage',
  'it/matches:cols.stage',
  'it/matches:insights.stage',
  'it/matches:drawer.fields.stage',
  'it/matches:filters.stage',
  'it/opportunities:cols.stage',
  'it/opportunities:insights.stage',
  'it/opportunities:drawer.stage',
  'it/opportunities:details.stage',
  'it/opportunities:changelog.fields.opportunity_stage_id',
  'it/opportunities:modal.fields.stage',
  'it/settings:nav.candidate_phases',
  'it/settings:candidateDisplay.fields.candidate_table_color_phase.label',
  'it/settings:applicationDisplay.fields.application_table_color_phase.label',
  'it/settings:lookups.phases.title',
  'it/settings:audit.field.phase',
  ...
  'pt/analytics:customers.axes.phase',
  'pt/applications:add.phase',
  'pt/applications:cols.phase',
  'pt/applications:insights.phase',
  'pt/applications:drawer.phase',
  'pt/applications:status.phase',
  'pt/candidates:columns.phase',
  'pt/candidates:filters.phase',
  'pt/candidates:drawer.phase',
  'pt/candidates:work.phase',
  'pt/candidates:changelog.axisPhase',
  'pt/candidates:changelog.fields.phase',
  'pt/candidates:matchesView.stage',
  'pt/customers:cols.phase',
  'pt/customers:filters.phase',
  'pt/customers:drawer.phase',
  'pt/customers:opportunities.col.stage',
  'pt/customers:modal.fields.phase',
  'pt/dashboard:feed.col.stage',
  'pt/matches:cols.stage',
  'pt/matches:insights.stage',
  'pt/matches:drawer.fields.stage',
  'pt/matches:filters.stage',
  'pt/opportunities:cols.stage',
  'pt/opportunities:insights.stage',
  'pt/opportunities:drawer.stage',
  'pt/opportunities:details.stage',
  'pt/opportunities:changelog.fields.opportunity_stage_id',
  'pt/opportunities:modal.fields.stage',
  'pt/settings:nav.candidate_phases',
  'pt/settings:candidateDisplay.fields.candidate_table_color_phase.label',
  'pt/settings:applicationDisplay.fields.application_table_color_phase.label',
  'pt/settings:lookups.phases.title',
  ...
  'it/common:lookupSeeds.driverLicenses.de',
