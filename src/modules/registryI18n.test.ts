...
const OUTPUT_FIELD_LABELS = [
  'AI-enabled', 'AI-interview extractieveld', 'Aangeroepen workflow', 'Aantal beschikbare diensten', 'Aantal keer gewerkt',
  ...
  'Dienst-ID', 'Direct uitgevoerd (sync)', 'E-mail', 'E-mail (ruw)', 'Eigenaar (recruiter-ID)', 'Einddatum dienstverband',
  ...
  'Header (Wo 08/07 23:00)', 'Huidige intake-status', 'Huisnummer', 'In wachtrij gezet', 'Inschrijfdatum',
  'Inschrijfdatum (afgeleid)', 'Inschrijfdatum (ruw, genest)', 'Kandidaat-ID',
  'Kenmerken (dagdienst/avonddienst/…)', 'Kind-run id', 'Klant-ID', 'Klantnaam', 'Laatst aangeboden', 'Laatst geboekt',
  ...
  'Type medewerker', 'Uitkomst kind-run (sync)', 'Vestiging', 'Volledige naam', 'Volledige naam (afgeleid)', 'Voornaam', 'Voornaam (ruw)',
