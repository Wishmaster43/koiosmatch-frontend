/**
 * ChangelogTab — the application's audit trail. Presentational; the fetch lives
 * in useApplicationActivity (§3). Handles the four UI states explicitly and shows
 * a calm empty state until the backend read endpoint is live (404 → empty).
 * Mirrors the opportunity/match changelog so every entity reads the same (§3A).
 */
