...
export default function OpportunitiesPage({ intent }: { intent?: unknown } = {}) {
  ...
  // 05-09), same as every other page toolbar. There is no opportunities.create
  // route (backend: opportunities.php:57-58 POST /opportunities sits in the
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <ViewSwitch active={view} views={[
            ...
            },
            {
              id: 'board',
              render: () => (
                <OpportunitiesBoard rows={boardRows} stages={stages} loading={loading} error={error}
