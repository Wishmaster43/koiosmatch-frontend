 ...
 * validated in step 3). Mirrors settings/importeren/UploadStep.tsx's dropzone,
 * permission notices and i18n keys; the one real difference is the primary action:
 * that screen's button runs the backend dry-run immediately, this one only parses
 * the file locally and moves to the column-mapping step.
 */
...
export default function UploadStep({ entity, canView, canImport, onFileReady }: UploadStepProps) {
  ...
  // Reject anything that isn't .csv/.txt with an honest, actionable message.
