...
// One lookup value row: value/label plus optional colour.
interface LookupChipItem { value: string | number; label: string; color?: string }
interface LookupChipSelectProps {
  label?: string
  hint?: string
  items: LookupChipItem[]
...
export default function LookupChipSelect({ label, hint, items, selected, onToggle, emptyText, ariaLabel }: LookupChipSelectProps) {
  return (
    <div>
      {label && (
