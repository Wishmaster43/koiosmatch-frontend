...
// A tenant lookup status entry — id/value are both accepted (mirrors the various lookup contexts).
interface StatusLookupItem { id?: string | number; value?: string | number; label: string }
interface DefaultStatusFilterPickerProps {
  statuses: StatusLookupItem[]
...
export default function DefaultStatusFilterPicker({ statuses, value, onChange }: DefaultStatusFilterPickerProps) {
