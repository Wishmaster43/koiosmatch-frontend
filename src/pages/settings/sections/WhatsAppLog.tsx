/**
 * WhatsAppLog — WhatsApp Message log: incoming + outgoing WhatsApp messages
 * as an audit-style log (direction/contact/message/status/date). Built on the
 * shared LogView, reusing the existing WhatsApp message data (which already
 * carries `direction`). Graceful: empty until there are messages.
 *
