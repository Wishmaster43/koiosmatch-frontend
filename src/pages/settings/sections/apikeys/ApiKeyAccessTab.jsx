    ...
    <div style={{ maxWidth: 680 }}>
      ...
      <div className="flex items-center justify-between" style={{ marginBottom: 14 }}>
        ...
        <button onClick={save} disabled={!dirty || saving}
          style={{ display: 'flex', alignItems: 'center', gap: 6, height: 32, padding: '0 14px', fontSize: 13, fontWeight: 500, border: 'none', borderRadius: 8, cursor: dirty && !saving ? 'pointer' : 'default', opacity: dirty || saved ? 1 : 0.55, background: saved ? 'var(--color-success)' : 'var(--color-primary)', color: 'white' }}>
