/**
 * EmbeddedSignupCard — the coexistence link-WIZARD on the WhatsApp settings
 * connection tab (WHATSAPP-COEXIST-PREP-1; Danny 23-08: "also add
 * the wizard to settings for WhatsApp"). Three honest states:
