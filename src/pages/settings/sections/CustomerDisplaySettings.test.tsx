...
// See CustomerDisplaySettings.tsx's own comment: the schema module is untyped .js.
...
// this test exercises the editor path, so the mocked viewer holds that permission.
...
describe('customerDisplay · new toggle flags default ON (today\'s behaviour)', () => {
  ...
  ])('%s stays checked when absent from /settings', async (key: string) => {
