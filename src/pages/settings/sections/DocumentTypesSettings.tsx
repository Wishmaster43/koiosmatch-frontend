 ...
 */
// Props: which entity's document-type lookup this tab renders (candidate/customer/…).
interface DocumentTypesSettingsProps {
  entity: string
}

export default function DocumentTypesSettings({ entity }: DocumentTypesSettingsProps) {
