...
function SecretField({ id, label, value, onChange, alreadySet, setBadge, placeholderSet, placeholderEmpty, showLabel, hideLabel }: SecretFieldProps) {
...
export default function FacebookLeadsSettings() {
  ...
  const save = async () => {
    setSaving(true)
    const payload: Record<string, string> = { facebook_dataset_id: datasetId }
