...
import { LogBadge, isAccessEvent, entityLabel, type AuditEntry } from './auditShared'
import { buildDiffCells } from './auditDiffCells'
import { Caption } from '@/components/ui/typography'
import Button from '@/components/ui/Button'

// The sortable column keys this table supports; null marks a non-sortable header.
...
export default function AuditLogTable({ rows, sortCol, sortDir, onSort, onRowClick }: AuditLogTableProps) {
  ...
  const TH = (col: SortCol | null): CSSProperties => ({
  ...
  const TD: CSSProperties = { padding: '10px 10px', fontSize: 12, color: 'var(--text)',
  ...
  const renderSortableTh = (col: SortCol, label: string, width: number) => {
