...
interface CvSection { id: string; enabled?: boolean; placement?: string }
// The subset of the CV template's saved settings this preview reads.
interface CvPreviewSettings {
  primaryColor?: string
