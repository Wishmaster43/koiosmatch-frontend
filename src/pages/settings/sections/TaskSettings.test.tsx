...
// A fixture task-status row, overridable per test.
interface StatusFixture { id: string; name: string; color: string; is_done: boolean }
// eslint-disable-next-line no-restricted-syntax -- DATA: a fixture row's tenant-picked colour, not a style rule.
const status = (over: Partial<StatusFixture> = {}): StatusFixture => ({ id: 'ts1', name: 'Afgerond', color: '#79B58E', is_done: false, ...over })
