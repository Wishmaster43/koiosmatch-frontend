...
// The two entities that carry a blacklist deployability status; picks the endpoint + setting key.
type BlacklistEntity = 'candidate' | 'customer'
 ...
 */
const ENDPOINTS: Record<BlacklistEntity, string> = {
...
const REQUIRED_KEYS: Record<BlacklistEntity, string> = {
  candidate: 'blacklist_reason_required',
  customer: 'customer_blacklist_reason_required',
}

// Props: which entity's blacklist-reason lookup this registration renders.
interface BlacklistReasonsSettingsProps {
  entity?: BlacklistEntity
}

export default function BlacklistReasonsSettings({ entity = 'candidate' }: BlacklistReasonsSettingsProps) {
