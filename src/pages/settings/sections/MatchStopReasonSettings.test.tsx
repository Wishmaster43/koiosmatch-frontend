...
// A fixture stop reason, overridable per test.
interface ReasonFixture { id: string; name: string; color: string }
// eslint-disable-next-line no-restricted-syntax -- DATA: a fixture reason's tenant-picked colour, not a style rule.
const reason = (over: Partial<ReasonFixture> = {}): ReasonFixture => ({ id: 'msr1', name: 'Candidate declined', color: '#D4573B', ...over })
