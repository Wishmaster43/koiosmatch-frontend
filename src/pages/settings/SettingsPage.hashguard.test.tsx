...
function DirtySection() {
  ...
  // this test always renders under the shell's real provider, so cast past the inferred null-only type.
  const ctx = useContext(SettingsDirtyContext) as unknown as { report: (d: boolean) => void }
