...
/**
 * MatchChangelogPopover — a History icon in the match drawer's title row that opens the
 * match's audit trail in a popover. Mirrors the candidate ChangelogPopover so record
 * history stays an ICON, never a changelog tab (§3A). Closes on outside-click / Escape.
 */
export default function MatchChangelogPopover({ match }: { match: MatchRow }) {
