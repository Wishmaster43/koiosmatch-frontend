 ...
 * 422s above per_page=500 (MatchQuery::rules()) while useListPageSize's shared
 ...
 * asks for per_page=500 — MatchesPage's `useListPageSize('matches',
...
vi.mock('@/context/AuthContext', () => ({
  useAuth: () => ({ user: { default_per_page: 900 }, hasPermission: () => true }),
}))
...
vi.mock('@/components/ui/PaginationBar', () => ({ default: () => null, PAGE_SIZE_OPTIONS: [50, 100, 500, 300, 400, 500] }))
