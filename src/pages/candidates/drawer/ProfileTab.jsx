...
/** Profile fields + profile text, each its own block with its own in-place
 * edit controls (pencil → save/cancel) shown ABOVE the block, not over the rows. */
      ...
      <div>
        ...
        <div style={blockStyle}>
          {[
            ...
            <div key={key} style={{ display: 'flex', alignItems: 'center', padding: '9px 12px', borderBottom: i < arr.length - 1 ? '1px solid var(--border)' : 'none', gap: 16 }}>
