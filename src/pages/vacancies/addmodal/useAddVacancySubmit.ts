...
const API_TO_FORM: Record<string, string> = {
  ...
  contract_types: 'contractTypes', start_date: 'startDate', end_date: 'endDate', positions_needed: 'positionsNeeded',
  ...
  const handleSubmit = async () => {
    ...
    try {
      const body = {
        ...
        ...(form.positionsNeeded ? { positions_needed: Number(form.positionsNeeded) } : {}),
