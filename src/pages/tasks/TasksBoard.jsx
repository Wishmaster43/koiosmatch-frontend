...
const isOverdue = (t) => t.due && !t.statusIsDone && new Date(t.due) < new Date(new Date().toDateString())
...
function BoardColumn({ column, items, onDragStart, onDrop, onDragOver, onSelect, selectedId, emptyText, formatDate, bureauLabel }) {
  return (
