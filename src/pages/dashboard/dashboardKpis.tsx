 ...
 * metrics read "—" until the backend feed lands — see DECISIONS.md (koiosmatch-api/docs; the dashboard plan folded into it 25-08)).
...
export function buildDashboardKpis({ t, kpis, drills = {}, num, eur, opp, onNavigate }: BuildArgs): Record<string, DashboardKpi> {
  ...
  return {
    ...
    stale:             { id: 'stale', label: t('kpi.notContacted6m'), value: num(kpis.stale_6m), sub: t('kpi.attentionNeeded'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: AlertCircle, onClick: resolveClick('stale_6m', () => onNavigate?.('candidates', { attention: 'stale6m' })) },
    ...
    fillRate:          { id: 'fillRate', label: t('kpi.fillRate'), value: kpis.fill_rate != null ? `${num(kpis.fill_rate)}%` : '—', sub: t('kpi.fillRateSub'), color: 'var(--color-success-text)', bg: 'var(--color-success-bg)', Icon: TrendingUp, onClick: resolveClick('fill_rate', () => onNavigate?.('vacancies', {})) },
    ...
    missingDocs:       { id: 'missingDocs', label: t('kpi.missingDocs'), value: num(kpis.missing_documents), sub: t('kpi.missingDocsSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: FileText, onClick: resolveClick('missing_documents', () => onNavigate?.('candidates', {})) },
    expiringContracts: { id: 'expiringContracts', label: t('kpi.expiringContracts'), value: num(kpis.expiring_contracts), sub: t('kpi.expiringContractsSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: CalendarClock, onClick: resolveClick('expiring_contracts', () => onNavigate?.('matches', {})) },
    ...
    openShifts:        { id: 'openShifts', label: t('kpi.openShifts'), value: num(kpis.open_shifts), sub: t('kpi.openShiftsSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: CalendarClock, onClick: resolveClick('open_shifts', () => onNavigate?.('planning', {})) },
    occupancy:         { id: 'occupancy', label: t('kpi.occupancy'), value: kpis.occupancy != null ? `${num(kpis.occupancy)}%` : '—', sub: t('kpi.occupancySub'), color: 'var(--color-primary-text)', bg: 'var(--color-primary-bg)', Icon: TrendingUp, onClick: resolveClick('occupancy', () => onNavigate?.('planning', {})) },
    ...
    tasksOverdue:      { id: 'tasksOverdue', label: t('kpi.tasksOverdue'), value: num(kpis.tasks_overdue), sub: t('kpi.tasksOverdueSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: AlertCircle, onClick: resolveClick('tasks_overdue', () => onNavigate?.('tasks', { kpi: 'overdue' })) },
    uncalledCallist:   { id: 'uncalledCallist', label: t('kpi.uncalledCallist'), value: num(kpis.calllist_uncalled), sub: t('kpi.uncalledCallistSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: PhoneOff, onClick: resolveClick('calllist_uncalled', () => onNavigate?.('outreach', {})) },
    expiringOpps:      { id: 'expiringOpps', label: t('kpi.expiringOpps'), value: num(kpis.expiring_opps), sub: t('kpi.expiringOppsSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: CalendarClock, onClick: resolveClick('expiring_opps', () => onNavigate?.('opportunities', { kpi: 'expiring' })) },
    ...
    tooLongInStage:    { id: 'tooLongInStage', label: t('kpi.tooLongInStage'), value: num(kpis.app_too_long_in_stage), sub: t('kpi.tooLongInStageSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: Hourglass, onClick: resolveClick('app_too_long_in_stage', () => onNavigate?.('applications', { attention: 'tooLongInStage' })) },
    missingApptApps:   { id: 'missingApptApps', label: t('kpi.missingApptApps'), value: num(kpis.app_missing_appointment), sub: t('kpi.missingApptAppsSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: CalendarX2, onClick: resolveClick('app_missing_appointment', () => onNavigate?.('applications', { attention: 'missingAppointment' })) },
    ...
    noFollowup:        { id: 'noFollowup', label: t('kpi.noFollowup'), value: num(kpis.no_followup), sub: t('kpi.attentionNeeded'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: AlertCircle, onClick: resolveClick('no_followup', () => onNavigate?.('candidates', { attention: 'noFollowup' })) },
    ...
    vacanciesStale:      { id: 'vacanciesStale', label: t('kpi.vacanciesStale'), value: num(kpis.vacancies_stale), sub: t('kpi.vacanciesStaleSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: Hourglass, onClick: resolveClick('vacancies_stale', () => onNavigate?.('vacancies', {})) },
    redeployDue:         { id: 'redeployDue', label: t('kpi.redeployDue'), value: num(kpis.redeploy_due_14d), sub: t('kpi.redeployDueSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: Repeat, onClick: resolveClick('redeploy_due_14d', () => onNavigate?.('matches', {})) },
    ...
    oppsStalled:         { id: 'oppsStalled', label: t('kpi.oppsStalled'), value: num(kpis.opps_stalled), sub: t('kpi.oppsStalledSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: Hourglass, onClick: resolveClick('opps_stalled', () => onNavigate?.('opportunities', {})) },
    ...
    documentsExpiring:   { id: 'documentsExpiring', label: t('kpi.documentsExpiring'), value: num(kpis.documents_expiring_30d), sub: t('kpi.documentsExpiringSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: FileText, onClick: resolveClick('documents_expiring_30d', () => onNavigate?.('candidates', {})) },
    openShifts48h:       { id: 'openShifts48h', label: t('kpi.openShifts48h'), value: num(kpis.open_shifts_48h), sub: t('kpi.openShifts48hSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: CalendarClock, onClick: resolveClick('open_shifts_48h', () => onNavigate?.('planning', {})) },
    shiftsUnconfirmed:   { id: 'shiftsUnconfirmed', label: t('kpi.shiftsUnconfirmed'), value: num(kpis.shifts_unconfirmed), sub: t('kpi.shiftsUnconfirmedSub'), color: 'var(--color-warning-text)', bg: 'var(--color-warning-bg)', Icon: AlertCircle, onClick: resolveClick('shifts_unconfirmed', () => onNavigate?.('planning', {})) },
