...
const buildItems = (onPick: (value: string | number) => void, onSelect: () => void): MenuNode[] => [
  {
...
describe('ActionMenu', () => {
  ...
  it('drills into a free-text input node and submits the text', async () => {
    ...
    const items: MenuNode[] = [{ key: 'note', label: 'Add note', input: true, placeholder: 'Write a note', submitLabel: 'Save', onSubmit }]
