 ...
 * (+ Add candidate, + Create match). Danny 24-07 point 6: the two had
 ...
 * and match/styles.ts.
 */
// NO minHeight (Danny 03-08, second round): pinning it made SHORT forms (department,
// contact person, opportunity) balloon to full height with dead space — eleven surfaces use
...
// KLANT-LAYOUT-4 / KANS-BREEDTE-1 (Danny 14-08: "must be wider, the text
// doesn't even fit" — the opportunity modal cut off its right column and scrolled sideways).
// 1060 -> 1200 here, so every wide create modal gains the room at once.
