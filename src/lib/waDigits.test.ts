...
import { waDigits } from './waDigits'

// Job 29 (2026-07-16), moved to lib (P1 follow-up 2026-07-20): the wa.me link needs
// bare E.164 digits — covers the two phone shapes seen in the candidate/contact
// dataset (with/without the +31 country code) plus the "too short to be real"
// guard that keeps a corrupted value from rendering a dead WhatsApp link.
describe('waDigits', () => {
