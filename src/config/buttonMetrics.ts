 ...
 * platform (§4/§9 consistency; KANDIDAAT-100 punt 50, Danny 2026-07-16: "all
 * buttons must have the same height"). BTN_H feeds `components/ui/Button`'s
 * size="md" ONLY — the page-toolbar "+ Add" exception beside 34px search chrome
 * (Danny 19-08: "drill downs must all be the same — same goes for
 * settings"). Settings save buttons, drawer/modal footers and bulk-bar
...
// The sm-standard height (THE SIZE: 28 · 12px · r6) for the few RAW state-carrying
